...
UPDATE :schema.infrastructure_link SET
    cost = CASE WHEN traffic_flow_direction_type IN (2, 4) THEN ST_Length(geom_3d) ELSE -1 END,
    reverse_cost = CASE WHEN traffic_flow_direction_type IN (2, 3) THEN ST_Length(geom_3d) ELSE -1 END;
